...
def upgrade():
    ...
    op.add_column('feed', sa.Column('cluster_tfidf', sa.Boolean(), nullable=True))
    op.add_column('feed', sa.Column('cluster_tfidf_min_score', sa.FLOAT(), nullable=True))
    op.add_column('feed', sa.Column('cluster_tfidf_same_cat', sa.Boolean(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('feed', 'cluster_tfidf_same_cat')
    op.drop_column('feed', 'cluster_tfidf_min_score')
    op.drop_column('feed', 'cluster_tfidf')
