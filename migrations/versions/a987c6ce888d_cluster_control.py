...
def upgrade():
    print('%s - adding cluster control options on user, category, '
            'and feed level' % datetime.now().isoformat())
    ...
    op.add_column('feed', sa.Column('cluster_conf', sa.PickleType(), nullable=True))
    ...
    op.add_column('category', sa.Column('cluster_conf', sa.PickleType(), nullable=True))
    ...
    op.add_column('user', sa.Column('cluster_conf', sa.PickleType(), nullable=True))
