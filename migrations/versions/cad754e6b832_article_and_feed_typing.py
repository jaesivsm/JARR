...
def upgrade():
    ...
    banner_status = postgresql.ENUM('active', 'inactive', 'archive', name='articletype')
    ...
    op.add_column('article', sa.Column('article_type', sa.Enum('text', 'image', 'video', name='articletype'), nullable=True))
    ...
    op.add_column('feed', sa.Column('feed_type', sa.Enum('classic', 'json', 'tumblr', 'instagram', 'soundcloud', 'reddit', 'fetch', 'koreus', 'twitter', name='feedtype'), nullable=True))
    op.add_column('feed', sa.Column('status', sa.Enum('active', 'paused', 'to_delete', 'deleting', name='feedstatus'), nullable=True))
