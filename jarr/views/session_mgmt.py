...
from jarr.views.forms import SigninForm, SignupForm
from jarr.views.common import admin_role, api_role, login_user_bundle
...
class OAuthSignIn:  # pragma: no cover
    ...
    def __init__(self, provider_name):
        ...
        self.consumer_id = getattr(conf.oauth, '%s_id' % provider_name.lower())
        self.consumer_secret \
                = getattr(conf.oauth, '%s_secret' % provider_name.lower())
